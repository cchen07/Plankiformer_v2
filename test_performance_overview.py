...
def plot_performance_baseline(aug_types, test_dataset, n_OOD_cells, accuracy, f1_score, BC, NMAE, outpath, remove_0):
    ...
    for i, aug_type in enumerate(aug_types):
        ...
        plt.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells-1), y=mean_accuracy[:len(test_dataset)-n_OOD_cells-1], yerr=sem_accuracy[:len(test_dataset)-n_OOD_cells-1], marker='s', capsize=3, ms=5, linestyle='', c='blue', label='ID')
        plt.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells-1, len(test_dataset)-n_OOD_cells), y=mean_accuracy[len(test_dataset)-n_OOD_cells-1:len(test_dataset)-n_OOD_cells], yerr=sem_accuracy[len(test_dataset)-n_OOD_cells-1:len(test_dataset)-n_OOD_cells], marker='s', capsize=3, ms=5, linestyle='', c='red', label='OOD overall')
        plt.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells, len(test_dataset)), y=mean_accuracy[len(test_dataset)-n_OOD_cells:], yerr=sem_accuracy[len(test_dataset)-n_OOD_cells:], marker='s', markerfacecolor='none', capsize=3, ms=5, linestyle='', c='orange', label='OOD cells')
    # plt.legend()
    ...
    for i, aug_type in enumerate(aug_types):
        ...
        plt.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells-1), y=mean_f1[:len(test_dataset)-n_OOD_cells-1], yerr=sem_f1[:len(test_dataset)-n_OOD_cells-1], marker='s', capsize=3, ms=5, linestyle='', c='blue', label='ID')
        plt.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells-1, len(test_dataset)-n_OOD_cells), y=mean_f1[len(test_dataset)-n_OOD_cells-1:len(test_dataset)-n_OOD_cells], yerr=sem_f1[len(test_dataset)-n_OOD_cells-1:len(test_dataset)-n_OOD_cells], marker='s', capsize=3, ms=5, linestyle='', c='red', label='OOD overall')
        plt.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells, len(test_dataset)), y=mean_f1[len(test_dataset)-n_OOD_cells:], yerr=sem_f1[len(test_dataset)-n_OOD_cells:], marker='s', markerfacecolor='none', capsize=3, ms=5, linestyle='', c='orange', label='OOD cells')
    # plt.legend()
    ...
    for i, aug_type in enumerate(aug_types):
        ...
        plt.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells-1), y=mean_BC[:len(test_dataset)-n_OOD_cells-1], yerr=sem_BC[:len(test_dataset)-n_OOD_cells-1], marker='s', capsize=3, ms=5, linestyle='', c='blue', label='ID')
        plt.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells-1, len(test_dataset)-n_OOD_cells), y=mean_BC[len(test_dataset)-n_OOD_cells-1:len(test_dataset)-n_OOD_cells], yerr=sem_BC[len(test_dataset)-n_OOD_cells-1:len(test_dataset)-n_OOD_cells], marker='s', capsize=3, ms=5, linestyle='', c='red', label='OOD overall')
        plt.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells, len(test_dataset)), y=mean_BC[len(test_dataset)-n_OOD_cells:], yerr=sem_BC[len(test_dataset)-n_OOD_cells:], marker='s', markerfacecolor='none', capsize=3, ms=5, linestyle='', c='orange', label='OOD cells')
    # plt.legend()
    ...
    for i, aug_type in enumerate(aug_types):
        ...
        plt.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells-1), y=mean_NMAE[:len(test_dataset)-n_OOD_cells-1], yerr=sem_NMAE[:len(test_dataset)-n_OOD_cells-1], marker='s', capsize=3, ms=5, linestyle='', c='blue', label='ID')
        plt.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells-1, len(test_dataset)-n_OOD_cells), y=mean_NMAE[len(test_dataset)-n_OOD_cells-1:len(test_dataset)-n_OOD_cells], yerr=sem_NMAE[len(test_dataset)-n_OOD_cells-1:len(test_dataset)-n_OOD_cells], marker='s', capsize=3, ms=5, linestyle='', c='red', label='OOD overall')
...
def plot_performance(aug_types, test_dataset, n_OOD_cells, accuracy, f1_score, BC, NMAE, outpath, remove_0):
    ...
    ax1.set_xticks(np.arange(len(test_dataset)), labels=test_dataset, rotation=45, rotation_mode='anchor', ha='right')
    # ax1.set_ylim(0.3, 1)
    ...
    for i, (aug_type, c) in enumerate(zip(aug_types, colors)):
        ...
        mean_accuracy = np.mean(accuracy_aug_type, axis=0)
        sem_accuracy = sem(accuracy_aug_type, axis=0)
        ax1.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells), y=mean_accuracy[:len(test_dataset)-n_OOD_cells], yerr=sem_accuracy[:len(test_dataset)-n_OOD_cells], marker='s', capsize=3, ms=5, linestyle='', color=c, label=aug_type)
        ax1.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells, len(test_dataset)), y=mean_accuracy[len(test_dataset)-n_OOD_cells:], yerr=sem_accuracy[len(test_dataset)-n_OOD_cells:], marker='s', markerfacecolor='none', capsize=3, ms=5, linestyle='', color=c, label=aug_type + ' on OOD cells')
    # plt.legend()

    ax2.set_xticks(np.arange(len(test_dataset)), labels=test_dataset, rotation=45, rotation_mode='anchor', ha='right')
    # ax2.set_ylim(0.3, 1)
    ...
    for i, (aug_type, c) in enumerate(zip(aug_types, colors)):
        ...
        mean_f1 = np.mean(f1_aug_type, axis=0)
        sem_f1 = sem(f1_aug_type, axis=0)
        ax2.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells), y=mean_f1[:len(test_dataset)-n_OOD_cells], yerr=sem_f1[:len(test_dataset)-n_OOD_cells], marker='s', capsize=3, ms=5, linestyle='', color=c, label=aug_type)
        ax2.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells, len(test_dataset)), y=mean_f1[len(test_dataset)-n_OOD_cells:], yerr=sem_f1[len(test_dataset)-n_OOD_cells:], marker='s', markerfacecolor='none', capsize=3, ms=5, linestyle='', color=c, label=aug_type + ' on OOD cells')
    # plt.legend()

    ax3.set_xticks(np.arange(len(test_dataset)), labels=test_dataset, rotation=45, rotation_mode='anchor', ha='right')
    ax3.set_title('Bray-Curtis Dissimilarity')
    for i, (aug_type, c) in enumerate(zip(aug_types, colors)):
        BC_aug_type = BC[int(i*n_model_aug):int((i+1)*n_model_aug)]
        mean_BC = np.mean(BC_aug_type, axis=0)
        sem_BC = sem(BC_aug_type, axis=0)
        ax3.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells), y=mean_BC[:len(test_dataset)-n_OOD_cells], yerr=sem_BC[:len(test_dataset)-n_OOD_cells], marker='s', capsize=3, ms=5, linestyle='', color=c, label=aug_type)
        ax3.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells, len(test_dataset)), y=mean_BC[len(test_dataset)-n_OOD_cells:], yerr=sem_BC[len(test_dataset)-n_OOD_cells:], marker='s', markerfacecolor='none', capsize=3, ms=5, linestyle='', color=c, label=aug_type + ' on OOD cells')
    # plt.legend()

    ax4.set_xticks(np.arange(len(test_dataset)), labels=test_dataset, rotation=45, rotation_mode='anchor', ha='right')
    ax4.set_title('Normalized Mean Absolute Error')
    for i, (aug_type, c) in enumerate(zip(aug_types, colors)):
        NMAE_aug_type = NMAE[int(i*n_model_aug):int((i+1)*n_model_aug)]
        mean_NMAE = np.mean(NMAE_aug_type, axis=0)
        sem_NMAE = sem(NMAE_aug_type, axis=0)
        ax4.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells), y=mean_NMAE[:len(test_dataset)-n_OOD_cells], yerr=sem_NMAE[:len(test_dataset)-n_OOD_cells], marker='s', capsize=3, ms=5, linestyle='', color=c, label=aug_type)
        ax4.errorbar(x=np.arange(len(test_dataset)-n_OOD_cells, len(test_dataset)), y=mean_NMAE[len(test_dataset)-n_OOD_cells:], yerr=sem_NMAE[len(test_dataset)-n_OOD_cells:], marker='s', markerfacecolor='none', capsize=3, ms=5, linestyle='', color=c, label=aug_type + ' on OOD cells')
    # plt.legend()
